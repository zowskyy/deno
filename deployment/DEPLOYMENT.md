...
```bash
# /etc/crontabs/root
*/15 * * * * gateway-probe --config /etc/gateway-probe/config.toml --store /overlay/gateway-probe/reports.db
*/15 * * * * gateway-probe-devices --store /overlay/gateway-probe/devices.db
